...
def train_loader(data_dir: str, batch_size=1, num_workers=1, window_size: int = 30, select: tuple = None,
...
def test_loader(data_dir: str, batch_size=1, num_workers=1, window_size: int = 30, select: tuple = None,
